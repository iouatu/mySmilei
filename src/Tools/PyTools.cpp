...
template void PyTools::extract<short>( std::string name, short &val, std::string component, int nComponent ); // Explicit instantiation of the template function void PyTools::extract()
