...
public:
    ...
    //! Ionization model per Species (tunnel)
    ...
    Species *electron_species; // can find this in the initializing list of the Species C-TOR
    //! Index of the species where field-ionized electrons go
    int electron_species_index; // can also find this in the initializing list of the Species C-TOR
    ...
    //! Pointer to the species where electron-positron pairs from the multiphoton Breit-Wheeler go
    Species *mBW_pair_species[2];
    //! Index of the species where electron-positron pairs from the multiphoton Breit-Wheeler go
