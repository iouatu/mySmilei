...
Ionization::Ionization( Params &params, Species *species ) // C-TOR of Ionization class.
{
    ...
    // au_to_w0 helps convert between atomic unit of frequency to SMILEI units of frequency.
}


Ionization::~Ionization() // Destructor for Ionization objects
{
}
